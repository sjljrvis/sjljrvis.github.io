        ...
        <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)]">
          ...
          <div className="game py-22">
            ...
            <div className="mb-4 flex flex-wrap items-center gap-x-8 gap-y-2 text-xs text-[var(--muted)]">
              <a className="inline-flex items-center gap-1 hover:text-[var(--foreground)]" href="mailto:sjlchougule@gmail.com">
              ...
              <a
                ...
                href="https://www.linkedin.com/in/sejal-chougule/"
                target="_blank"
                rel="noreferrer"
              >
                <svg aria-hidden="true" viewBox="0 0 24 24" className="h-3.5 w-3.5 fill-current">
              ...
              <a
                className="inline-flex items-center gap-1 hover:text-[var(--foreground)]"
                href="https://github.com/sjljrvis"
                target="_blank"
                rel="noreferrer"
              >
                <svg aria-hidden="true" viewBox="0 0 24 24" className="h-3.5 w-3.5 fill-current">
